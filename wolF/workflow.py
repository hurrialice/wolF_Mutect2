...
def mutect2_workflow(pair_name, t_name, n_name,
    ...
    # Split intervals
    intervals = SplitIntervals(ref_files["ref_fasta"],
                               ref_files["interval_list"], 
                               scatter_count=scatter_count)["subintervals"]

    # MuTect2 scatter          
    m2_outputs = MuTect2(pair_name=pair_name,
                         case_name=t_name,
                         ctrl_name=n_name,
                         t_bam=t_bam, 
                         t_bai=t_bai,
    ...
    # MuTect2 gather
    m2g_outputs = GatherMuTect2(all_vcf_input=[m2_outputs["scatter_vcf"]])
